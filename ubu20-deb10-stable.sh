...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Senjakun/scvps/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Senjakun/scvps/main/ip"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6283805609815"}]]}' 
...
wget -q https://raw.githubusercontent.com/Senjakun/scvps/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
